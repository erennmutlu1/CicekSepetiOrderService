...
namespace CicekSepetiOrderService.Context
{

    class CiceksepetiOrderContext
    {
        ...
        public class CicekSepetiOrders
        {
            ...
            public IList<SupplierOrderListWithBranch> supplierOrderListWithBranch { get; set; }
        }

        public class SupplierOrderListWithBranch
        {
